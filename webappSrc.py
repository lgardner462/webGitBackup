...
def ack_account():
	...
	return template("ack_accountBeta", usersList=usersList, ackList=ackList, groupsList = groupsList, groupsDict = groupsDict)

########################################################################################################
########################################################################################################

@route('/ack_accountBeta', method = 'POST')
def ack_account():
        # for template
	chgroupDict = {}
	chgroupList = {}
